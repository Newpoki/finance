...
/**
 * Imported from https://github.com/shadcn-ui/ui/pull/4421
 * As Shadcn is not compatible yet with react-day-picker 9
 */
function Calendar({
  className,
  classNames,
    ...
    <DayPicker
      ...
      components={{
        ...
        CaptionLabel: ({ children, ...props }) => {
          ...
          return (
            <Button
              className="h-7 w-full truncate text-sm font-medium hover:bg-grey-100"
              variant="ghost"
              size="icon"
              onClick={() => {
